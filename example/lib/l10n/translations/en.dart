const en = {
  ...
  'Phone': 'Phone',
  'Mail': 'Mail',
  'EasyRefresh.nested example':
      'Official NestedScrollView with EasyRefresh.nested',
  'NestedScrollView example': 'Per-tab Header and Footer (NestedScrollView)',
  'Carousel': 'Carousel',
  ...
  'TabBarView example': 'Page-level NestedScrollView refresh (shared load)',
  'Paging': 'Paging',
  'Paging example': 'Paging example',
  'No Data': 'No Data',
  'Theme switch': 'Theme switch',
  'Theme switch example': 'Theme switch example',
  'Theme switch describe': 'Pull down to display the switching panel, slide left and right to select the theme color, and release to switch.',
