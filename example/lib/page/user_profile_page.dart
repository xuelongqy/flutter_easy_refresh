...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(Translations.of(context).text("userProfile"),
          style: TextStyle(
            color: Colors.white
          ),
        ),
          ...
          children: <Widget>[
            ...
            new Stack(
              children: <Widget>[
                ...
                ClipPath(
                  clipper: new TopBarClipper(MediaQuery.of(context).size.width, 200.0),
                  child:new SizedBox(
                    width: double.infinity,
                    height:200.0,
                    child:  new Container(
                        ...
                        child: new PreferredSize(
                          child: new Container(
                            child: new ClipOval(
                              child: new Container(
                                color: Colors.white,
                                child: new Image.asset("assets/image/head.jpg"),
                              ),
                            ),
                          ),
                    ...
                    child: Column(
                      children: <Widget>[
                        ListItem(
                          ...
                          title: Translations.of(context).text("name"),
                          titleColor: Colors.white,
                          describe: "KnoYo",
                          describeColor: Colors.white,
                        ),
                        ListItem(
                          icon: EmptyIcon(),
                          title: Translations.of(context).text("old"),
                          titleColor: Colors.white,
                          describe: Translations.of(context).text("noBald"),
                          describeColor: Colors.white,
                        ),
                        ListItem(
                          icon: EmptyIcon(),
                          title: Translations.of(context).text("city"),
                          titleColor: Colors.white,
                          describe: Translations.of(context).text("hangzhou"),
                          describeColor: Colors.white,
                        )
                      ],
                    ),
