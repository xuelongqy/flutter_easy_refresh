...
/// TabView页面
class TabViewsPage extends StatefulWidget {
  @override
  _TabViewsPageState createState() => _TabViewsPageState();
}

class _TabViewsPageState extends State<TabViewsPage>
        ...
        body: Column(
          children: <Widget>[
            Card(
              ...
              child: new TabBar(controller: _tabController, tabs: justtabs,
            )),
            Expanded(
              child: TabBarView(
