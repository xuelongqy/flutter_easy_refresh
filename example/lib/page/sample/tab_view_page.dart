...
class _TabViewPageState extends State<TabViewPage> with SingleTickerProviderStateMixin {
  ...
  GlobalKey<RefreshHeaderState> _headerKeyList = new GlobalKey<RefreshHeaderState>();
  GlobalKey<RefreshFooterState> _footerKeyList = new GlobalKey<RefreshFooterState>();
  GlobalKey<RefreshHeaderState> _headerKeyGrid = new GlobalKey<RefreshHeaderState>();
  GlobalKey<RefreshFooterState> _footerKeyGrid = new GlobalKey<RefreshFooterState>();
                  ...
                  child: new ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      return new Container(
                          ...
                          child: Card(
                            child: new Center(
                              child: new Text(strList[index],style: new TextStyle(fontSize: 18.0),),
                            ),
                          )
                      );
                    },
                  ...
                  child: new GridView.builder(
                    ...
                    itemBuilder: (BuildContext context,int index){
                      return new Container(
                          ...
                          child: Card(
                            child: new Center(
                              child: new Text(strGrid[index],style: new TextStyle(fontSize: 18.0),),
                            ),
                          )
                      );
                    },
